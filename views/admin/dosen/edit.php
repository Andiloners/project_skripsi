                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="container-fluid">
                            ...
                            <div class="navbar-nav ms-auto">
                                <a href="index.php?role=admin&controller=Dosen&action=index" class="btn btn-secondary">
                    ...
                    <div class="p-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="index.php?role=admin&controller=Dosen&action=edit&id=<?php echo $dosen['id']; ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
